...
<body>
    ...
    <form class="form-inline d-flex align-items-end <?= $tipo == "alumno" || $tipo == "profesor" ? "d-none" : " " ?>" method="GET" action="">
    ...
    <form method="post" class="row g-3 <?= $tipo == "alumno" || $tipo == "profesor" ? "" : " d-none" ?>">
        ...
        <div class="col-12 col-md-6">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="cur-esp-2" id="radioNoMayorEdad" value="<?= $tipo == "alumno" ? "alumno" : "profesor" ?>""> 
        ...
        <div class="d-flex justify-content-center"><button name="alta" class=" btn btn-success">Dar Alta</button></div>
    </form>
    <?php
